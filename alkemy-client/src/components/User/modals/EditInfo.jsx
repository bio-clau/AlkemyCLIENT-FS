...
import {Modal, Fade, Box, Typography, FormControl, InputLabel, OutlinedInput, InputAdornment, Backdrop, Stack, Input, IconButton} from '@mui/material';
    ...
    const [values, setValues] = useState({
      ...
      async function handleSubmitUpdate(e) {
        ...
        if (!values.firstName || !values.lastName || !values.email) {
          ...
          setLoading(true);
          await dispatch(updateUser(values.firstName, values.lastName, values.email, currentUser.id, values.image, values.uploadImg, localStorage.getItem('USER_TOKEN')));
        //   if (dir) {
